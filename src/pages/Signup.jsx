...
import {adminReg} from '@redux/actions';
			...
			<Container maxWidth="sm">
				<Formik
					...
					validationSchema={Yup.object().shape({
						...
						adminId: Yup.string().max(255).required("admin code is required"),

					})}
					onSubmit={(values, { setSubmitting }) => {
						console.log('submit')
						dispatch(adminReg(values));
						setSubmitting(false);
					}}
				>
					{({
						...
						<form onSubmit={handleSubmit}>
							<Box mb={3}>
								...
								<Typography
									...
									variant="body2"
								>
									Choose new email to create new student account
								</Typography>
							</Box>
							<TextField
